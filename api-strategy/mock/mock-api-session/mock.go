...
// Source: github.com/pefish/go-interface/i-core (interfaces: IApiSession)

// Package mock_i_core is a generated GoMock package.
package mock_i_core
...
func (m *MockIApiSession) Api() i_core.IApi {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Api")
	ret0, _ := ret[0].(i_core.IApi)
	return ret0
}
...
func (m *MockIApiSession) Logger() i_logger.ILogger {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Logger")
	ret0, _ := ret[0].(i_logger.ILogger)
	return ret0
}
...
func (m *MockIApiSession) SetApi(arg0 i_core.IApi) {
	m.ctrl.T.Helper()
...
func (m *MockIApiSession) SetStatusCode(arg0 t_core.StatusCode) {
	m.ctrl.T.Helper()
