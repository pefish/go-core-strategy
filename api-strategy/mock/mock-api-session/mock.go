...
// Source: github.com/pefish/go-core-strategy/type (interfaces: IApiSession)
...
func (m *MockIApiSession) Api() _type.IApi {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Api")
	ret0, _ := ret[0].(_type.IApi)
	return ret0
}
...
func (m *MockIApiSession) SetApi(arg0 _type.IApi) {
	m.ctrl.T.Helper()
